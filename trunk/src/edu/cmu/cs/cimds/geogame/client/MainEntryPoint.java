...
public class MainEntryPoint implements EntryPoint {
	...
	{
		Maps.loadMapsApi("AIzaSyCYxUskKdoF8Ne0ZKyiTHvFXfG6a_llw-Y", "2.x", false, new Runnable(){

			@Override
			public void run() {
				// do nothing, since this should be done long before it gets called.
	...
	public void onModuleLoad() {
		...
		final MapWidget map = new MapWidget(startLocation, 9);
		...
		//This is here to remove cookies when they navigate away from the page.
		Window.addCloseHandler(new CloseHandler(){
			@Override
            public void onClose(CloseEvent event) {
				LoginPanel.removeNormalLoginCookies();
				LoginPanel.removeAdminLoginCookies();
			}
		});
	}
